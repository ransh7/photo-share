...
def delete_friend(request, id):
	...
	frind_profile = get_object_or_404(Profile, id=id)
	user_profile.friends.remove(frind_profile)
	frind_profile.friends.remove(user_profile)
	return HttpResponseRedirect('/users/{}'.format(frind_profile.slug))
